      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white border-b border-border transition-colors duration-200">
        ...
        <div className="h-[60px] md:h-[60px] flex items-center justify-between px-[20px] md:px-[30px] relative z-50 bg-white">
          ...
          <div className="flex md:hidden items-center justify-end flex-1">
            <BookNowDialog
              trigger={
                <button className="text-foreground text-[12px] font-accent font-normal tracking-[1.4px] uppercase hover:opacity-60 transition-opacity text-right flex items-center justify-end gap-2">
                  <span>BOOK NOW</span>
                  {plusIcon}
                </button>
              }
          ...
          <div className="hidden md:flex items-center gap-[25px]">
            <BookNowDialog
              trigger={
                <button className="text-foreground text-[15px] font-accent font-medium tracking-[1.4px] uppercase hover:text-primary transition-colors flex items-center gap-2">
                  <span>BOOK NOW</span>
                  {plusIcon}
                </button>
              }
