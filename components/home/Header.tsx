        ...
        <div className="flex md:hidden items-center">
          <Sheet>
            <SheetTrigger asChild>
              <button className="text-foreground text-[14px] font-accent font-normal tracking-[1.4px] uppercase hover:opacity-60 transition-opacity">
                MENU
              </button>
            </SheetTrigger>
            <SheetContent
                  ...
                  <nav className="flex flex-col divide-y divide-border">
                    ...
                    <Dialog>
                      <DialogTrigger asChild>
                        <button className="flex h-[56px] items-center px-[32px] text-foreground text-left text-[16px] font-accent font-normal tracking-[1.4px] uppercase hover:text-primary transition-colors w-full">
                          CONTACT
                        </button>
                      </DialogTrigger>
                    ...
                    <div className="h-[56px] flex items-center px-[32px]">
                      <Button className="w-full bg-white hover:bg-white/90 text-foreground text-[12px] font-accent tracking-[1.3px] font-normal uppercase px-[10px] h-[40px] rounded-sm">
                        BOOK NOW
                      </Button>
                    </div>
                  </nav>
