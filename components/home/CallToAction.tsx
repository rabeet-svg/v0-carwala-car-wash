    ...
    <section className="relative py-32 overflow-hidden">
      ...
      <div className="container relative z-20 mx-auto px-4 text-center">
        ...
        <div className="flex justify-center">
          <BookNowDialog
            trigger={
              <Button className="bg-white text-black hover:bg-gray-100 rounded-none px-7.5 py-3.75 h-auto text-xs tracking-[1.3px] font-normal uppercase flex items-center gap-3 transition-colors">
